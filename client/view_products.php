               ...
               <table class="table text-center text-white border border-3 border-secondary table-bordered">
                  <tbody class="font-weight-normal text-center">
                     ...
                     <tr class="d-flex align-items-center">
                        <td class="flex-grow-1">Bé hơn 20m²</td>
                        <td>5.000.000/ tháng</td>
                     </tr>
                     <tr class="d-flex align-items-center">
                        <td class="flex-grow-1">Bé hơn 30m² </td>
                        <td>6.000.000/ tháng</td>
                     </tr>
                     <tr class="d-flex align-items-center">
                        <td class="flex-grow-1">Bé hơn 40m²</td>
                        <td> 7.000.000/ tháng</td>
                     </tr>
                     <tr class="d-flex align-items-center">
                        <td class="flex-grow-1">Bé hơn 50m² </td>
                        <td>8.000.000/ tháng</td>
                     </tr>
                  </tbody>
               </table>
            </div>
...
<section class="products">
   ...
   <div class="col-lg-12 pagination text-center">
        ...
        <a href="#">&laquo;</a>
        <a class="active" href="view_products.php">1</a>
        <a href="view_products1.php">2</a>
